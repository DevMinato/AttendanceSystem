...
{
    public class AddPastorCommandValidator : AbstractValidator<AddPastorCommand>
    {
        ...
        public AddPastorCommandValidator(IAsyncRepository<Pastor> pastorRepository, IAsyncRepository<Fellowship> fellowshipRepository)
        {
        ...
        private async Task<bool> IsEmailAddressUnique(AddPastorCommand command, CancellationToken cancellationToken)
        {
            try
            {
        ...
        async Task<bool> IsPhoneNumberUnique(AddPastorCommand command, CancellationToken cancellationToken)
        {
            try
            {
